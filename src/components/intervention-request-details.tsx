...
import { WorkReportData } from '@/types/intervention';
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="text-sm text-gray-600 dark:text-gray-400">
          Aggiornato: {request.created_at ? new Date(request.created_at).toLocaleDateString('it-IT') : 'N/A'}
        </div>
      </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border border-gray-200 dark:border-gray-600">
          <div className="mb-4">
            ...
            {work_report_data.time_entries.map((entry, index) => {
              ...
              return (
                <div key={index} className="mb-4 pb-4 border-b border-gray-200 dark:border-gray-700 last:mb-0 last:border-b-0 last:pb-0">
                  <div className="flex justify-between items-start">
                    <div className="min-w-0 flex-1">
                      ...
                      <span className="ml-4 text-gray-600 dark:text-gray-400">
                        {entry.total_hours > 0 && `${entry.total_hours} ore`}
                      </span>
                    </div>
                  </div>
                </div>
